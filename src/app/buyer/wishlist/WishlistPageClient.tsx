  ...
  if (wishlistIds.length === 0) {
    return (
      <div className="bg-white rounded-sm shadow-sm p-16 text-center">
        ...
        <a href="/" className="bg-[#7C3AED] text-white px-8 py-2.5 rounded-md text-sm font-medium hover:bg-[#6D28D9] transition-all duration-200 active:scale-95 shadow-sm hover:shadow-md inline-block">
          Mulai Belanja
        </a>
      </div>
    )
